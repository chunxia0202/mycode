...
# 预训练模型
RESUME_PATH = '/opt/data/private/qianmi/CAN/save_model/MALC_coarse/checkpoint_053.pth.tar'  # directory you want to resume the model
# 模型存储路径
SAVE_DIR = '/opt/data/private/qianmi/CAN/save_model/MALC_coarse/'  # directory you want to save the model
# 分割类别
NUM_CLASS = 28  # for MALC-coarse grained use 28, for MALC-fine grained use 139
# 不用改，保留true
